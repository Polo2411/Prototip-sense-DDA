...
public class EyeBall : MonoBehaviour
{
    ...
    public int maxHealth = 200; // Vida máxima del enemigo
    public int damagePerProjectile = 10; // Daño recibido por proyectil
    public int damagePerChargedProjectile = 100; // Daño recibido por proyectil cargado
